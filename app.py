...
# Allow frontend (index.html) to communicate with API
app.add_middleware(
    CORSMiddleware,
...
class CreditData(BaseModel):
    ...
    age: int
    pay_0: int  # Payment status (e.g., -1=pay duly, 1=1 month delay, etc.)
    pay_2: int
    pay_3: int
    pay_4: int
    pay_5: int
...
def read_root():
    try:
        with open("index.html", "r") as f:
            return {"message": "Credit Risk API is running. Visit /docs for API docs or serve index.html via web server."}
    except:
